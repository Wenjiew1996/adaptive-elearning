    ...
    return <div className="container pt-1">
        <form onSubmit={handleEditQuiz}>
            ...
            {/* <div style={ { marginTop:'10px' }}>
                <Input addonBefore="Learning Object: " placeholder="LO1" /><br/>
                <Input style={ { marginTop:'10px' }} addonBefore="Pre-Condtion: " placeholder="LO1, LO2..." /><br/>
                <Input style={ { marginTop:'10px' }} addonBefore="Appear At Page: " placeholder="1, 2, 3..." /><br/>
            </div> */}
